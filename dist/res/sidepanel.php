<section id="left-sidebar" class="pl-4 col-span-2 text-center h-screen bg-[#01004C]/5 flex flex-col justify-between sticky bottom-0 left-0 select-none">
    ...
    <div class="flex flex-col h-full items-end content-between justify-between bg-white border rounded-t-xl py-5">
        <div class="flex flex-col w-full px-5 mx-auto font-medium text-[#0a088a]">
            ...
            <a class="relative text-left hover:text-[#3230bb] transition-all duration-150 rounded-lg hover:bg-[#1512d4]/20 active:bg-[#1512d4]/50 xl:py-2 xl:px-4 2xl:py-2.5 hover:pl-5" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                <div class="absolute h-6 w-1 left-0 rounded-l-[1px] rounded-r-2xl bg-inherit bg-white"></div>
            ...
            <a href="./siswa.php" class="relative text-left text-[#0a088a] hover:text-[#3230bb] transition-all duration-150 rounded-lg mt-1.5 hover:bg-[#1512d4]/20 active:bg-[#1512d4]/50 xl:py-2 xl:px-4 2xl:py-2.5 hover:pl-5">
            ...
            <a href="./guru.php" class="relative text-left text-[#0a088a] hover:text-[#3230bb] transition-all duration-150 rounded-lg mt-1.5 hover:bg-[#1512d4]/20 active:bg-[#1512d4]/50 xl:py-2 xl:px-4 2xl:py-2.5 hover:pl-5">
                <div class="absolute h-6 w-1 left-0 rounded-l-[1px] rounded-r-2xl bg-inherit"></div>
                <span class="fi fi-br-users relative top-0.5 mr-2.5"></span>
                Guru
            </a>
        ...
        <div class="mx-auto flex flex-col justify-center w-full">
            ...
            <a href="./res/logout.php" class="bg-[#01004C]/5 text-center text-[#01004C] rounded-full transition-all duration-150 hover:bg-[#0a088a]/10 active:bg-[#1512d4]/30 xl:mx-14 2xl:mx-20 xl:py-2 2xl:py-2.5 font-semibold"><span class="fi fi-br-sign-out-alt relative top-0.5 mr-2.5"></span>Keluar</a>
        </div>
    </div>
</section>