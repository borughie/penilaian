                        <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="modalKonfirmasi<?= $data['idlaporan'] ?>" tabindex="-1" aria-modal="true" role="dialog">
                                ...
                                <div class="modal-content border-none relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                                    <div class="modal-header flex flex-shrink-0 items-center justify-center pt-8 border-gray-200 rounded-t-md" style="backdrop-filter: blur(4px);">
                                        <div class="inline-block p-4 bg-blue-50 rounded-full">
                                            <svg class="w-16 h-16 fill-current text-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    ...
                                    <form method="POST" action="./res/aksi_crud.php">
                                        ...
                                        <input type="hidden" name="tpoint" value="<?= $data['point'] ?>">
                                        <div class="modal-body relative">
                                            <div class="px-4 pb-3 sm:p-6">
                                                <h5 class="text-center font-semibold text-slate-900">Apakah anda yakin akan Konfirmasi data ini? <br>
                                                    <span class="font-extrabold text-transparent text-3xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600"><?= $data['namasiswa'] ?> - <?= $data['point'] ?></span>
                                                </h5>
                                            </div>
                                            <div class="px-4 pb-5 text-center mx-auto sm:px-6 rounded-b-md">
                                                ...
                                                <button type="submit" class="inline-flex justify-center rounded-md border border-transparent bg-blue-600/80 hover:bg-blue-700/80 py-2 w-32 text-sm font-semibold text-white shadow-sm transition-all" name="bkonfirmasilaporan">Konfirmasi</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
