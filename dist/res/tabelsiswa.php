<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="modalTabelSiswa" tabindex="-1" aria-modal="true" role="dialog">
                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50 border-b-2 border-gray-200">
                                <tr>
                                    ...
                                    <th class="p-3 text-sm font-semibold tracking-wide text-center">Jurusan</th>
                            ...
                            <tbody id="tbsiswa">
                                ...
                                ?>
                                    <tr class="odd:bg-[#0a088a]/5 even:bg-[#0a088a]/10 hover:bg-gray-50">
                                        ...
                                        <td class="p-3 text-sm text-gray-700 text-center whitespace-nowrap"><?= $data['kelas'] ?></td>
                                        <td class="p-3 text-sm text-gray-700 text-center whitespace-nowrap"><?= $data['jurusan'] ?></td>
                                        <td class="p-1.5 text-sm text-gray-700 text-center whitespace-nowrap">
                                            <a href="laporanbaru.php?hal=pilih&nis=<?= $data['nis'] ?>" class="p-1.5 text-xs font-bold uppercase tracking-wider rounded-lg text-blue-800 bg-blue-200/50 hover:bg-blue-400/60 active:bg-blue-400 transition-all">Pilih</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
