...
<body onload="<?= @$pesan ?>">
    <div class="grid grid-cols-12">
        ...
        <section id="content" class="col-span-7 bg-[#01004C]/5 text-center h-screen">
            ...
            <div class="m-10 p-4 bg-white rounded-2xl shadow-sm relative flex items-center justify-between">
                <div class="grid grid-cols-3 w-full grid-flow-row gap-x-3 items-center justify-between">
                    <div class="w-full bg-slate-300">
                        <div class="text-left">Pelanggaran <br> Bulan Ini</div>
                        <div class="font-semibold text-lg text-right">12</div>
                    </div>
                    <div class="w-full bg-slate-400 rounded-lg h-full">
                        <div class="text-left">On Proses</div>
                        <div class="font-semibold text-lg text-right">8</div>
                    </div>
                    <div class="w-full bg-slate-400 rounded-lg h-full">
                        <div class="text-left">Selesai</div>
                        <div class="font-semibold text-lg text-right">4</div>
                    </div>
                </div>
            </div>
    </div>
